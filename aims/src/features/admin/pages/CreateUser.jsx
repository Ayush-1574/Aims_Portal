        ...
        <div className="bg-gradient-to-r from-slate-900 to-slate-800 p-8 text-white">
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <p className="text-slate-400">Add a new user to the system manually.</p>
            </div>
          </div>
        </div>
              ...
              <div className="p-6 bg-purple-50/50 rounded-2xl border border-purple-100 animate-slide-up space-y-4">
                 ...
                 <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div className="space-y-2">
                       ...
                       <select 
                          className="flex h-11 w-full rounded-xl border border-slate-200 bg-white px-3 py-2 text-sm focus:ring-2 focus:ring-purple-500/20 focus:border-purple-500 outline-none transition-all"
                          name="department" 
